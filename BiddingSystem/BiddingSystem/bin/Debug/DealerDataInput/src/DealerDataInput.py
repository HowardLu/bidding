...
# 所有常數字串
Const			= {	"STATICTEXTNAME":												u"委託方",
							"STATICTEXTCOUNTRY":										u"國籍",
							"STATICTEXTCARDID":											u"證件號碼",
							"STATICTEXTCONTRACTDATE":								u"合約日期",
							"STATICTEXTCONTRACTID":									u"合約編號",
							"STATICTEXTEL":													u"電話",
							"STATICTEXTCELLPHONE":									u"手機",
							"STATICTEXFAX":													u"傳真",
							"STATICTEXTADDRESS":										u"詳細地址",
							"STATICTEXTBANKNAME":										u"開戶銀行",
							"STATICTEXTBANKACC":										u"銀行帳戶",
							"STATICTEXTPOSTID":											u"郵編",
							"STATICTEXTDEALERLIST":									u"賣家列表",
							"STATICTEXTIFDEALED":										u"如拍品成交：",
							"STATICTEXTIFNDEALED":									u"如拍品未成交：",
							"STATICTEXTIFDEALEDINSURANCEFEE":				u"保險費 = 落槌價之",
							"STATICTEXTIFDEALEDSERVICEFEE":					u"服務費 = 落槌價之",
							"STATICTEXTIFNDEALEDINSURANCEFEE":			u"保險費 = 保留價之",
							"STATICTEXTIFNDEALEDSERVICEFEE":				u"服務費 = 保留價之",
							"STATICTEXTPICTUREFEE":									u"圖錄費 =",
							"STATICTEXTOTHERFEE":										u"其它費用：",
							"STATICTEXTFRAMEFEE":										u"裝裱/鏡框/囊匣 =",
							"STATICTEXTFIREFEE":										u"火      漆      費 =",
							"STATICTEXTIDENTIFYFEE":								u"鑒      定      費 =",
							"STATICTEXTITEMLIST":										u"委託拍賣標的列表",
							"BUTTONTEXTADD":												u"新增",
							"BUTTONTEXTFIX":												u"修正",
							"BUTTONTEXTDEL":												u"刪除",
							"BUTTONTEXTSET":												u"設定",
							...
							"STATICTEXTNTDPERITEM":									u"NTD/件",
							"STATICTEXTITEMNAME":										u"拍賣標的名稱",
							"STATICTEXTBUILDIMG":										u"建檔圖片",
							"STATICTEXTPACKIMG":										u"包裝圖片",
							"STATICTEXTITEMNUM":										u"數量",
							"STATICTEXTSPEC":												u"規格(cm)",
							"STATICTEXTRESERVEPRICE":								u"保留價(NTD)",
							"STATICTEXTRESERVEPRICEPOST":						u"萬",
							"STATICTEXTREMAIN":											u"保存現狀",
							"STATICTEXTITEMPS":											u"備註",
							"STATICTEXTLOTNO":											u"拍品編號",
							"STATICTEXTNOTSET":											u"未設定",
							...
							"NO_SELECTED_ITEM":											u"請選擇一個拍品",
							"FIX_DATA_DONE":												u"已成功修改[%s]的資料",
							"NO_DEALER_DATA":												u"查無買家資料!! ID = %d",
							"DEL_DATA_SUCCESS":											u"成功刪除了[%s]",
							"WIN_TITLE_TEXT":												u"賣家資料建檔系統",
							...
							"PLZ_ENTER_AUCTION_IP":									u"請輸入拍賣中心的IP位址",
