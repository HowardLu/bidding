    ...
    public partial class CheckoutDealerForm : Form
    {
        ...
        private void buttonQuery_Click(object sender, EventArgs e)
        {
            ...
            foreach (DealerItemEntity dealerItem in dealerItemList)
            {
                ...
                {
                    Console.WriteLine("[CheckoutDealerForm.buttonQuery_Click] dealerItem.LotNO = " + dealerItem.LotNO + " not dealed");
                    continue;
                }
        ...
        private void _saveDoc(bool toPrint = true)
        {
            ...
            //save doc
            string savePath = Path.Combine(System.Windows.Forms.Application.StartupPath, m_dealer.Name);
