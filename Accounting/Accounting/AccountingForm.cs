                                              ...
                                              ref DealerEntity dealer)
        {
            ...
            if (m_isSuperUser)
            {
                dataGridView1.Rows.Add(dealerItem._id, auction.AuctionId, auction.Artwork, dealerItem.Spec, auction.BidderNumber, bidder.Name,
                    auction.StockState, dealerItem.SrcDealer, Utility.GetEnumString(typeof(ReturnState), auction.ReturnState),
            ...
            {
                dataGridView1.Rows.Add(dealerItem._id, auction.AuctionId, auction.Artwork, dealerItem.Spec, auction.BidderNumber, bidder.Name,
                    auction.StockState, Utility.GetEnumString(typeof(ReturnState), auction.ReturnState), hammerPrice,
