...
namespace Bidding
{
    ...
    public partial class DisplayForm_M_16_9 : DisplayFormBase
    {
        //[DllImport("gdi32.dll")]
        ...
        private void DisplayForm_M_16_9_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayForm_M_16_9_Resize(object sender, EventArgs e)
        {
            if (m_formSize.Width == 0 || m_formSize.Height == 0)
                return;
            float xRatio = (float)this.Width / m_formSize.Width;
            ...
            Console.WriteLine("DisplayForm_M_16_9_Resize -----------");
        ...
        private void DisplayForm_M_16_9_FormClosed(object sender, FormClosedEventArgs e)
        {
