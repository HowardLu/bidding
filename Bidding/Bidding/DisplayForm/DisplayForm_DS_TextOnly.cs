...
namespace Bidding
{
    public partial class DisplayForm_DS_TextOnly : DisplayFormBase
    {
        //[DllImport("gdi32.dll")]
        ...
        public DisplayForm_DS_TextOnly()
        {
            InitializeComponent();
        ...
        private void DisplayForm_DS_TextOnly_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayForm_DS_TextOnly_Resize(object sender, EventArgs e)
        {
            if (m_formSize.Width == 0 || m_formSize.Height == 0)
                return;
            float xRatio = (float)this.Width / m_formSize.Width;
            ...
            Console.WriteLine("DisplayForm_DS_TextOnly_Resize -----------");
        ...
        private void DisplayForm_DS_TextOnly_FormClosed(object sender, FormClosedEventArgs e)
        {
