...
namespace Bidding
{
    public partial class DisplayForm_G_4_3 : DisplayFormBase
    {
        //[DllImport("gdi32.dll")]
        ...
        private void DisplayForm_G_4_3_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayForm_G_4_3_Resize(object sender, EventArgs e)
        {
            if (m_formSize.Width == 0 || m_formSize.Height == 0)
                return;
            float xRatio = (float)this.Width / m_formSize.Width;
            ...
            Console.WriteLine("DisplayForm_G_4_3_Resize -----------");
