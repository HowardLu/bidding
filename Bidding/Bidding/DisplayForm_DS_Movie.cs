...
namespace Bidding
{
    public partial class DisplayForm_DS_Movie : DisplayFormBase
    {
        //[DllImport("gdi32.dll")]
        ...
        public DisplayForm_DS_Movie()
        {
            InitializeComponent();
            this.splitContainer1.Panel1.Controls.Add(lotLabel);
        ...
        private void DisplayForm_DS_Movie_Load(object sender, EventArgs e)
        {
        ...
        private void DisplayForm_DS_Movie_Resize(object sender, EventArgs e)
        {
            if (m_formSize.Width == 0 || m_formSize.Height == 0)
                return;
            float xRatio = (float)this.Width / m_formSize.Width;
            ...
            Console.WriteLine("DisplayForm_DS_Movie_Resize -----------");
        ...
        public override void SetAuctionOnForm(Auction auction)
        {
            ...
            this.axWindowsMediaPlayer1.URL = Application.StartupPath + @"/" + auction.videoPath;// @"C:\Wildlife.wmv";
