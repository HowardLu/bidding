...
namespace Bidding
{
    ...
    public partial class DisplayForm_DS_4_3 : DisplayFormBase
    {
        //[DllImport("gdi32.dll")]
        ...
        private ControlState m_auctionPictureBoxState;
        ...
        public DisplayForm_DS_4_3()
        {
            ...
            Control cAuctionPictureBox = (Control)auctionPictureBox;
            m_auctionPictureBoxState = new ControlState(cAuctionPictureBox.Location, cAuctionPictureBox.Size, cAuctionPictureBox.Font.Size, ref cAuctionPictureBox);
        ...
        private void ReArrangeAll(float xRatio, float yRatio)
        {
            ...
            //m_auctionPictureBoxState.ReArrange(xRatio, yRatio);
        }

        public override void SetLogo(BiddingCompany auctioneer)
        {
            switch (auctioneer)
            {
